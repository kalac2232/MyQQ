...
public class RegisterActivity extends Activity implements View.OnClickListener {
    ...
    private LoginEditText register_nickname;
    private LoginEditText register_pw;
    private LoginEditText register_telephone;
    ...
    private void initUI() {
        ...
        register_nickname = (LoginEditText) findViewById(R.id.register_nickname); //昵称输入框
        register_pw = (LoginEditText) findViewById(R.id.register_pw); //密码输入框
        register_telephone = (LoginEditText) findViewById(R.id.register_telephone); // 电话输入框
    ...
    private void RegisterClick() {
        ...
        if (!nickname.equals("") && !password.equals("") && !telephone.equals("")) {
            RegisterRequest(password,telephone,nickname,String.valueOf(SELECTED_HEADICONNUMBER));
        }
