...
public class NaviBarRadioButton extends RadioButton  {
    ...
    private void init(final String type) {
        switch (type) {
            case "消息":
                icon_selected = getResources().getDrawable(R.drawable.skin_tab_icon_conversation_selected);
                smallIcon_Selected = getResources().getDrawable(R.drawable.face_conversation_selected);
                icon_Normal = getResources().getDrawable(R.drawable.skin_tab_icon_conversation_normal);
                smallIcon_Normal = getResources().getDrawable(R.drawable.face_conversation_normal);
                initialFaceOffset = 7;
                break;
            case "联系人":
                icon_selected = getResources().getDrawable(R.drawable.skin_tab_icon_contact_selected);
                smallIcon_Selected = getResources().getDrawable(R.drawable.face_contact_selected);
                icon_Normal = getResources().getDrawable(R.drawable.skin_tab_icon_contact_normal);
                smallIcon_Normal = getResources().getDrawable(R.drawable.face_contact_normal);
                break;
            case "动态":
                icon_selected = getResources().getDrawable(R.drawable.skin_tab_icon_plugin_selected);
                smallIcon_Selected = getResources().getDrawable(R.drawable.face_plugin_selected);
                icon_Normal = getResources().getDrawable(R.drawable.skin_tab_icon_plugin_normal);
                smallIcon_Normal = getResources().getDrawable(R.drawable.skin_tab_icon_plugin_normal);
                break;
        }
