...
public class SlideMenuView_other extends ViewGroup {
    ...
    public SlideMenuView_other(Context context) {
        super(context);
        init();
    }
    ...
    public SlideMenuView_other(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SlideMenuView_other(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        leftMenu.layout(-leftMenu.getMeasuredWidth()+200,0,100,b);
